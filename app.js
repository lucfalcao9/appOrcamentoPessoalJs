...
class Bd {
	...
	recuperarTodosRegistros() {
		...
		for (let i = 1; i <= id; i++) {
			...
			//existe a possibilidade de ids pulados/removidos
			//nestes casos vamos pular esses ids
			if (despesa === null) {
				continue
			}
...
function cadastrarDespesa() {
	...
	if (despesa.validarDados()) {
		...
		document.getElementById("descricaoMod").innerHTML = "Despesa cadastrada com sucesso!"
		...
		document.getElementById("descricaoMod").innerHTML = "Existem campos obrigatórios ñ preenchidos"
